...
public class PlayerSounds{
	...
	public PlayerSounds(){
		clips = new Clip[]{Loader.jumpSound0, Loader.skidSound, Loader.spinSound, Loader.spindashChargeSound, Loader.spindashReleaseSound, Loader.trickSound, Loader.boostSound,
			Loader.dashSound, Loader.popSound, Loader.ringSound, Loader.springSound, Loader.springPoleSound, Loader.voice3, Loader.voice2, Loader.voice1, Loader.voiceGo};
	...
	public void resumeAllSounds(){
		if(paused){
			paused = false;
			for(int i = 0; i < clips.length; i++){ if(wasPlaying[i]){ clips[i].start(); } }
		}
	}
