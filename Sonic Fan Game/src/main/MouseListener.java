...
public class MouseListener{
	...
	private MouseListener(){ scrollX = scrollY = xPos = yPos = lastX = lastY = 0; }
	...
	public static void mouseButtonCallback(long window, int button, int action, int mods){
		...
		if(action == GLFW_RELEASE) if(button < get().mouseButtonPressed.length) get().mouseButtonPressed[button] = get().isDragging = false;
	}
