...
public class Image{
	...
	public void setColor(float[] color){
		vertexArray[3] = color[0];
		vertexArray[4] = color[1];
		vertexArray[5] = color[2];
		vertexArray[6] = color[3];
		vertexArray[12] = color[0];
		vertexArray[13] = color[1];
		vertexArray[14] = color[2];
		vertexArray[15] = color[3];
		vertexArray[21] = color[0];
		vertexArray[22] = color[1];
		vertexArray[23] = color[2];
		vertexArray[24] = color[3];
		vertexArray[30] = color[0];
		vertexArray[31] = color[1];
		vertexArray[32] = color[2];
		vertexArray[33] = color[3];
	}
	...
	public float[] getPositions(){ return new float[]{vertexArray[0], vertexArray[1], vertexArray[9], vertexArray[10], vertexArray[18], vertexArray[19], vertexArray[27], vertexArray[28]}; }
	
	public float[] getPositions2(){
		return new float[]{vertexArray[0], vertexArray[1], vertexArray[2], vertexArray[9], vertexArray[10], vertexArray[11], vertexArray[18], vertexArray[19], vertexArray[20],
			vertexArray[27], vertexArray[28], vertexArray[29]};
	}
	
	public float[] getColors(){
		return new float[]{vertexArray[3], vertexArray[4], vertexArray[5], vertexArray[6], vertexArray[12], vertexArray[13], vertexArray[14], vertexArray[15], vertexArray[21],
			vertexArray[22], vertexArray[23], vertexArray[24], vertexArray[30], vertexArray[31], vertexArray[32], vertexArray[33]};
	}
	
	public float[] getUVMaps(){ return new float[]{vertexArray[7], vertexArray[8], vertexArray[16], vertexArray[17], vertexArray[25], vertexArray[26], vertexArray[34], vertexArray[35]}; }
	...
	private double[] rotate(double x, double y, double ox, double oy, double angle){
		double tx = ox + (x - ox) * cos(angle) - (y - oy) * sin(angle), ty = oy + (x - ox) * sin(angle) + (y - oy) * cos(angle);
